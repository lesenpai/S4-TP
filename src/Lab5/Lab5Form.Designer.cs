...
namespace S4_TP.Lab5
{
	partial class Lab5Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlCanvas = new S4_TP.Lab5.Lab5Form.CustomPanel();
			...
			// ofd
			// 
			this.ofd.Filter = "PNG (*.png)|*png|JPEG (*.jpeg)|*.jpeg|BMP (*.bmp)|*.bmp|All files (*.*)|*.*";
			this.ofd.FileOk += new System.ComponentModel.CancelEventHandler(this.Ofd_FileOk);
			// 
			// sfd
			// 
			this.sfd.Filter = "PNG (*.png)|*png|JPEG (*.jpeg)|*.jpeg|BMP (*.bmp)|*.bmp|All files (*.*)|*.*";
