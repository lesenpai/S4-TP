namespace S4_TP.Lab1
{
	partial class Lab1Form
	{
		...
		{
			this.Buttons_tlp = new System.Windows.Forms.TableLayoutPanel();
			...
			this.Expression_lbl = new System.Windows.Forms.Label();
			this.Result_lbl = new System.Windows.Forms.Label();
			this.Expression_tb = new System.Windows.Forms.TextBox();
			this.Result_tb = new System.Windows.Forms.TextBox();
			this.Buttons_tlp.SuspendLayout();
			this.SuspendLayout();
			// 
			// Buttons_tlp
			// 
			...
			this.Buttons_tlp.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this.Buttons_tlp.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this.Buttons_tlp.Controls.Add(this.Btn_div, 3, 2);
			this.Buttons_tlp.Controls.Add(this.Btn_7, 0, 2);
			this.Buttons_tlp.Controls.Add(this.Btn_closeBracket, 1, 0);
			this.Buttons_tlp.Controls.Add(this.Btn_9, 2, 2);
			this.Buttons_tlp.Controls.Add(this.Btn_openBracket, 0, 0);
			this.Buttons_tlp.Controls.Add(this.Btn_clear, 2, 0);
			this.Buttons_tlp.Controls.Add(this.Btn_8, 1, 2);
			this.Buttons_tlp.Controls.Add(this.Btn_plus, 3, 5);
			this.Buttons_tlp.Controls.Add(this.Btn_mul, 3, 3);
			this.Buttons_tlp.Controls.Add(this.Btn_minus, 3, 4);
			this.Buttons_tlp.Controls.Add(this.Btn_equal, 2, 5);
			this.Buttons_tlp.Controls.Add(this.Btn_4, 0, 3);
			this.Buttons_tlp.Controls.Add(this.Btn_dot, 1, 5);
			this.Buttons_tlp.Controls.Add(this.Btn_5, 1, 3);
			this.Buttons_tlp.Controls.Add(this.Btn_0, 0, 5);
			this.Buttons_tlp.Controls.Add(this.Btn_1, 0, 4);
			this.Buttons_tlp.Controls.Add(this.Btn_3, 2, 4);
			this.Buttons_tlp.Controls.Add(this.Btn_2, 1, 4);
			this.Buttons_tlp.Controls.Add(this.Btn_6, 2, 3);
			this.Buttons_tlp.Controls.Add(this.Btn_power, 3, 1);
			this.Buttons_tlp.Controls.Add(this.Btn_backspace, 3, 0);
			this.Buttons_tlp.Font = new System.Drawing.Font("Microsoft Sans Serif", 20F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.Buttons_tlp.Location = new System.Drawing.Point(0, 162);
			this.Buttons_tlp.Name = "Buttons_tlp";
			this.Buttons_tlp.RowCount = 6;
			this.Buttons_tlp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.Buttons_tlp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.Buttons_tlp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.Buttons_tlp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.Buttons_tlp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.Buttons_tlp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.Buttons_tlp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
			this.Buttons_tlp.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
			this.Buttons_tlp.Size = new System.Drawing.Size(399, 409);
			this.Buttons_tlp.TabIndex = 23;
			// 
			// Btn_div
			// 
			this.Btn_div.Dock = System.Windows.Forms.DockStyle.Fill;
			this.Btn_div.Location = new System.Drawing.Point(297, 136);
			...
			this.Btn_closeBracket.Location = new System.Drawing.Point(99, 0);
			this.Btn_closeBracket.Margin = new System.Windows.Forms.Padding(0);
			...
			this.Btn_openBracket.Location = new System.Drawing.Point(0, 0);
			this.Btn_openBracket.Margin = new System.Windows.Forms.Padding(0);
			...
			this.Btn_clear.Location = new System.Drawing.Point(198, 0);
			...
			this.Btn_plus.Location = new System.Drawing.Point(297, 340);
			...
			this.Btn_mul.Location = new System.Drawing.Point(297, 204);
			...
			this.Btn_minus.Location = new System.Drawing.Point(297, 272);
			...
			this.Btn_equal.Location = new System.Drawing.Point(198, 340);
			...
			this.Btn_dot.Location = new System.Drawing.Point(99, 340);
			...
			this.Btn_0.Location = new System.Drawing.Point(0, 340);
			...
			this.Btn_1.Location = new System.Drawing.Point(0, 272);
			...
			this.Btn_3.Location = new System.Drawing.Point(198, 272);
			...
			this.Btn_6.Location = new System.Drawing.Point(198, 204);
			...
			this.Btn_power.Location = new System.Drawing.Point(297, 68);
			...
			this.Btn_backspace.Location = new System.Drawing.Point(297, 0);
			...
			this.Expression_tb.Name = "Expression_tb";
			this.Expression_tb.ReadOnly = true;
			this.Expression_tb.Size = new System.Drawing.Size(390, 47);
			this.Expression_tb.TabIndex = 26;
			this.Expression_tb.WordWrap = false;
			// 
			// Result_tb
			// 
			...
			this.Result_tb.Size = new System.Drawing.Size(390, 47);
			...
			this.Controls.Add(this.Expression_tb);
		...
		#endregion
		private System.Windows.Forms.TableLayoutPanel Buttons_tlp;
		...
		private System.Windows.Forms.Label Expression_lbl;
		private System.Windows.Forms.Label Result_lbl;
		private System.Windows.Forms.TextBox Expression_tb;
